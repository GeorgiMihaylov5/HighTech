...
import { FavoritesComponent } from './overview/components/favorites/favorites.component';
import { ConfiguratorComponent } from './configurator/components/configurator/configurator.component';
import { DashboardComponent } from './manage/components/control-panel/components/dashboard/dashboard.component';
import { CompareComponent } from './overview/components/compare/compare.component';
...
const routes: Routes = [
  ...
  { path: 'configurator', component: ConfiguratorComponent, canActivate: [AuthorizeGuard] },
  { path: 'basket', component: BasketComponent, canActivate: [AuthorizeGuard] },
    ...
    path: 'manage', component: ManageComponent, canActivate: [AuthorizeGuard], children: [
      ...
      { path: 'change-password', component: ChangePasswordComponent, canActivate: [AuthorizeGuard], outlet: 'manage' },
      {
        path: 'control-panel', component: ControlPanelComponent, outlet: 'manage', canActivate: [AuthorizeGuard], data: employeeRights, children: [
          { path: '', component: DashboardComponent, canActivate: [AuthorizeGuard], data: employeeRights, outlet: 'control-panel' },
          { path: 'dashboard', component: DashboardComponent, canActivate: [AuthorizeGuard], data: adminRights, outlet: 'control-panel' },
          { path: 'orders', component: OrdersComponent, canActivate: [AuthorizeGuard], data: employeeRights, outlet: 'control-panel' },
