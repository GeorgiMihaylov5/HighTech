        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FieldId = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuildId = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryFields_CategoryId_FieldId",
                table: "CategoryFields",
                columns: new[] { "CategoryId", "FieldId" },
                unique: true,
                filter: "[CategoryId] IS NOT NULL AND [FieldId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderedProducts_BuildId",
